...
API_ID = int(environ.get('28394784'))
API_HASH = environ.get('9544a3ad7d8660acbae0dcf553c808e5')
BOT_TOKEN = environ.get('5847064573:AAGC0OerM5XtAjKjQ1JLy0jAKrkDcM3osI4')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1966376217',).split()]
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b><i>{file_name} » {file_size} › [Klaus](https://t.me/sai_movies_backup)</i></b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b><i>{file_name} » {file_size} › [Klaus](https://t.me/sai_movies_backup)</i></b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🏷 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a> \n🔮 𝖸𝖾𝖺𝗋: {year} \n⭐️ 𝖱𝖺𝗍𝗂𝗇𝗀𝗌: {rating}/ 10 \n🎭 𝖦𝖾𝗇𝖾𝗋𝗌: {genres} \n\n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [Klaus](https://t.me/sai_movies_backup)")
